  ...
  <div class="container pb-10 mt-[120px] max-w-[954px]">
    <div>
      ...
      <div class="space-y-8 mt-[88px]">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4 pl-8">
            <div class="space-y-4">
              ...
              <ul class="space-y-4 list-circle pl-8">
                <li class="subtitle">
                ...
                <li class="subtitle">
                  Communications. If you contact us directly, for example, with
                  an inquiry or a support request, we may receive additional
                  personal data about you, including your email address and the
            ...
            <div class="space-y-2">
              ...
              <ul class="list-circle pl-8 space-y-4">
                <li class="subtitle">
                  Device Information. We receive information about the device
                  and software you use to access our Services, including
                  Internet Protocol (IP) address, web browser type, operating
                  system version, and device identifiers.
                </li>
                <li class="subtitle">
                  Usage Information. To help us understand how you use our
                  Services, including the Demo portion of our website, and to
                  help us improve them, we automatically receive information
                  about your interactions with our Services. This information
                  includes records of your transactions and information about
                  your other activities related to our services, such as the
                  date and time of your sessions, the pages you view, links
                  to/from any page, and time spent in a session. Some of the
                  data we gather through cookies and similar technologies as
                  discussed below.
                </li>
                <li class="subtitle">
                  Location Information. We may collect or infer your general
                  location information when you use our Services. For example,
                  your IP address may indicate your general geographic region,
                  which will be matched against our IP whitelist.
                </li>
              </ul>
            </div>
            <div class="space-y-2">
              ...
              <ul class="space-y-4 pl-8 list-circle">
                <li class="subtitle">
                  Partners. We may retrieve additional personal data about you
                  from third parties and other identification/verification
                  services, such as your financial institution and payment
                  processor. We may combine that data with other information we
                  have about you.
                </li>
                <li class="subtitle">
                ...
                <li class="subtitle">
                  ...
                  interests for website visitors based on the web pages you
                  view.
                </li>
              </ul>
            </div>
          ...
          <p class="subtitle">
            ...
            provide or allow information necessary for certain services or
            features, those services or features may not be available or fully
            functional.
          </p>
          <p class="subtitle">
            Marketing and Communications information includes your preferences
        ...
        <div class="space-y-4">
          <h1 class="heading">4. How We Use Your Personal Information</h1>
          <p class="subtitle">
          ...
          <ul class="pl-8 space-y-4 list-disc">
            ...
            <li class="subtitle">
              ...
              relating to the use of our website(s) and the Services, including
              to comply with all applicable local and international laws and
              regulations;
            </li>
            <div>
              <li class="subtitle">For our legitimate interests including:</li>
              <ul class="pl-8 space-y-4 list-circle my-4">
                <li class="subtitle">
        ...
        <div class="space-y-4">
          <h1 class="heading">5. Disclosure of personal data</h1>
          <p class="subtitle">
            ...
            party without your consent except as necessary to provide the
            Services or as described in this Privacy Policy.
          </p>
          <ul class="pl-8 space-y-4 list-disc">
            <li class="subtitle">
              <span class="font-bold font-roobert-bold">Merchants.</span> We may
              share your contact information with merchants as part of your
            ...
            <li class="subtitle">
              <span class="font-bold font-roobert-bold"
                >Service providers.</span
              >
              We share personal data with vendors or agents working on our
              behalf for the purposes described in this statement. For example,
              companies we've hired to provide customer service support, to
              protect and secure our systems and services, or to perform
              sanctions screening and identity verification services may need
              access to personal data to provide those functions. The processing
              by such third parties shall be governed by a written contract with
            ...
            <li class="subtitle">
              <span class="font-bold font-roobert-bold">Affiliates.</span>
            ...
            <li class="subtitle">
              <span class="font-bold font-roobert-bold">Partners.</span>
              We may share your data with companies we partner with for industry
            ...
            <li class="subtitle">
              ...
              >
              We may disclose personal data as part of a corporate transaction
              or proceeding such as a merger, financing, acquisition,
              bankruptcy, dissolution, transfer, divestiture, or sale of all or
            ...
            <li class="subtitle">
              ...
              <ul class="pl-8 list-circle space-y-4 mt-6">
                <li class="subtitle">
                  protect our Users and others, for example, to prevent fraud or
                ...
                <li class="subtitle">
                  protect the rights or property or ourselves or others,
          ...
          <p class="subtitle">
            ...
            through our website and apps, including account information,
            marketing and communications data, demographic data, content and
            files, geolocation data, usage data, and inferences associated with
            identifiers and device information (such as cookie IDs, device IDs,
            and IP address) as described in the Cookies section of this
            statement. This data is aggregated and enables us to perform
            analytics and track the performance of our website. For example, we
            use Google Analytics on our website to help us understand how users
            interact with our website; you can learn how Google collects and
            uses information at www.google.com/policies/privacy/ partners.
          </p>
          <p class="subtitle">
          ...
          <p class="subtitle">
            ...
            Redstone’s Merchant Terms of Use does not allow the other
            transacting party to use your information for anything other than as
            authorized by you, Paystack is not responsible for their actions,
            including their data protection practices. If you provide personal
            data to any of those third parties or allow us to share personal
            data with them, that data is governed by their privacy policies.
          </p>
        </div>
      </div>
    </div>
